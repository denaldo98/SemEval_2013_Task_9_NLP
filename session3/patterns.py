...
def check_LCS_svo(tree,tkE1,tkE2):
   ...
   if tkE1 is not None and tkE2 is not None:
      ...
      if tree.get_tag(lcs)[0:2] == "VB" :  # LCS is a verb     
         ...
         func1 = tree.get_rel(path1[-1]) if path1 else None #last element of the path 
...
# check pattern: same entities in the pair
...
# check pattern: brand followed by group
...
# check pattern: entity1 parent of entity 2
